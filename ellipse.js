$(document).ready(function () {
  ...
  $('.display').each(function () {
    var 
      ...
      showAt = $this.attr('data-display-at') * 40,
      hideAt = $next.attr('data-display-at') * 40,
      duration = ($this.attr('data-transition') || 0) * 40,
      nextDuration = $next.attr('data-transition') * 40,
